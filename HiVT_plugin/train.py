...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/Users/xichen/Documents/paper2-traj-pred/DAIR-V2X-Seq/dataset/v2x-seq-tfd/V2X-Seq-TFD-Example/cooperative-vehicle-infrastructure/fusion_for_prediction/')
